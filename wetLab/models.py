...
class Biosample(UserOwner, References):
    ...
    biosample_type =  models.ForeignKey('organization.JsonObjField',on_delete=models.CASCADE, related_name='biotype', null=True, blank=True, verbose_name="BiosampleCellCulture Details",help_text="JsonObjField")
...
class Barcode(models.Model):
    barcode_name = models.CharField(max_length=50, null=False, default="")
