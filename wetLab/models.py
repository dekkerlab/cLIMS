...
class Document(models.Model):
    name = models.CharField(max_length=50, null=True, blank=True, help_text="Name of the document", validators=[alphanumeric])
...
class Vendor(models.Model):
    vendor_title = models.CharField(max_length=100, null=False, default="", help_text="The complete name of the originating lab or vendor.", validators=[alphanumeric])
...
class Construct(models.Model):
    construct_name = models.CharField(max_length=50, null=False, default="", help_text="Short name for construct - letters, numbers, hyphens or underscores allowed (no spaces)", validators=[alphanumeric])
...
class  GenomicRegions(models.Model):
    name = models.CharField(max_length=50, null=False, default="", help_text="Please give a name.", validators=[alphanumeric])
...
class Modification(UserOwner,References): 
    modification_name = models.CharField(max_length=50, null=False, default="", validators=[alphanumeric])
...
class Individual(References, UserOwner):
    individual_name = models.CharField(max_length=50, null=False, default="", validators=[alphanumeric])
...
class Enzyme(References):
    enzyme_name = models.CharField(max_length=50, null=False, default="", help_text="The name of the digestion enzyme.", validators=[alphanumeric])
...
class Biosource(References):
    biosource_name = models.CharField(max_length=50, null=False, default="", validators=[alphanumeric])
...
class TreatmentRnai(References, UserOwner):
    treatmentRnai_name = models.CharField(max_length=50, null=False, default="",validators=[alphanumeric])
...
class TreatmentChemical(References, UserOwner):
    treatmentChemical_name = models.CharField(max_length=50, null=False, default="", validators=[alphanumeric])
...
class Biosample(UserOwner, References):
    biosample_name = models.CharField(max_length=50, null=False, default="", validators=[alphanumeric])
